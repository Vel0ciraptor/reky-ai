...
const PublishProperty = () => {
    ...
    const [activeTab, setActiveTab] = useState<'property' | 'requirements'>('property');
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-8 border-b border-glass-border pb-4">
                <div className="flex items-center gap-4">
                    <div className="w-10 h-10 bg-accent-orange/20 text-accent-orange rounded-xl flex items-center justify-center flex-shrink-0">
                        {activeTab === 'property' ? <Plus size={22} /> : <MessageCircle size={22} />}
                    </div>
                    <div>
                        <h1 className="text-2xl font-bold">{activeTab === 'property' ? 'Publicar Inmueble' : 'Requerimientos'}</h1>
                        <p className="text-gray-500 text-sm">
                            {activeTab === 'property' ? 'Completa los datos para que otros agentes puedan colaborar.' : 'Explora lo que buscan otros agentes y contacta.'}
                        </p>
                    </div>
                </div>
                ...
                <div className="flex bg-white/5 p-1 rounded-xl w-full sm:w-auto">
                    <button
                        ...
                        className={`flex-1 sm:flex-none px-5 py-2 rounded-lg text-sm transition-all font-medium ${activeTab === 'property' ? 'bg-accent-orange text-white shadow-md' : 'text-gray-400 hover:text-white'}`}
                    >
                        Inmueble
                    </button>
                    <button
                        onClick={() => setActiveTab('requirements')}
                        className={`flex-1 sm:flex-none px-5 py-2 rounded-lg text-sm transition-all font-medium ${activeTab === 'requirements' ? 'bg-accent-orange text-white shadow-md' : 'text-gray-400 hover:text-white'}`}
                    >
                        Pedidos
                    </button>
                </div>
