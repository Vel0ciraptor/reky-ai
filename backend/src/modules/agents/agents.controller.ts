...
export class AgentsController {
    ...
    uploadIdentity(@Request() req: any, @Body() body: { frontUrl: string, backUrl: string }) {
        return this.agentsService.uploadIdentity(req.user.id, body.frontUrl, body.backUrl);
    }
    ...
    updateProfile(@Request() req: any, @Body() body: { name?: string; lastName?: string; phone?: string }) {
